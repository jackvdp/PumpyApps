...
public struct ExtDisplaySettingsRows: View {
    ...
    public init(displayContent: Binding<ExtDisContentType>, showQRCode: Binding<Bool>, qrURL: Binding<String>, marqueeTextLabel: Binding<String>, marqueeSpeed: Binding<Double>, qrType: Binding<QRType>) {
        self._displayContent = displayContent
        self._showQRCode = showQRCode
        self._qrURL = qrURL
        self._marqueeTextLabel = marqueeTextLabel
        self._marqueeSpeed = marqueeSpeed
        self._qrType = qrType
    }
